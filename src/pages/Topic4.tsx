    ...
    <div className="min-h-screen py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <header className="text-center mb-10">
          <img src={saveIconImg} alt="Сақтау" className="w-20 h-20 mx-auto mb-4 animate-bounce-slow" />
        ...
        <section className="card-topic border-secondary mb-8">
          <h2 className="text-2xl font-bold mb-4 flex items-center gap-3">
            <img src={saveIconImg} alt="Сақтау" className="w-10 h-10 rounded-lg" />
            Жобаны қалай сақтаймыз? 🤔
          </h2>
          ...
          <div className="space-y-4">
            <StepCard number={1} image={openFolderImg} title="Файл мәзірін аш" description="Жоғарғы сол жақта 'Файл' деген жерді бас 👆" />
            <StepCard number={2} image={saveIconImg} title="'Компьютерге сақтау' дегенді бас" description="Немесе 'Save to your computer' 💻" />
            <StepCard number={3} emoji="✏️📝" title="Жобаға атау бер" description="Мысалы: 'менің_мысығым' 🐱 немесе 'билейтін_шар' 🎈" />
            <StepCard number={4} emoji="✅👍" title="Сақтау түймесін бас" description="Енді жобаң компьютерде сақталды! 🎉" />
          </div>
        </section>
        ...
        <section className="card-topic border-accent mb-8">
          <h2 className="text-2xl font-bold mb-4 flex items-center gap-3">
            <img src={openFolderImg} alt="Ашу" className="w-10 h-10 rounded-lg" />
            Жобаны қалай ашамыз? 🔓
          </h2>
          <p className="text-lg leading-relaxed mb-6">
          ...
          <div className="space-y-4">
            <StepCard number={1} image={openFolderImg} title="Файл мәзірін аш" description="Жоғарғы сол жақта 'Файл' деген жерді бас 👆" />
            <StepCard number={2} emoji="📁⬆️" title="'Компьютерден жүктеу' дегенді бас" description="Немесе 'Load from your computer' 💻" />
            <StepCard number={3} emoji="🔍👀" title="Жобаңды тап" description="Компьютерден сақталған файлды тауып, таңда 📄" />
            <StepCard number={4} emoji="✅🎉" title="Ашу түймесін бас" description="Жобаң қайта ашылды! 🚀" />
          </div>
        </section>
  ...
  return (
    <div className="task-card">
      <h3 className="text-xl font-bold mb-4 flex items-center gap-3">
        ...
        <img src={saveIconImg} alt="Сақтау" className="w-8 h-8 rounded-lg" />
      </h3>
      <p className="text-muted-foreground mb-4 flex items-center gap-2">
        <img src={saveIconImg} alt="Сақтау" className="w-8 h-8 rounded-lg" />
        Жобаны сақтау қадамдарын дұрыс ретке қой! ⬆️⬇️
      </p>
        ...
        {items.map((item, index) => (
          <div key={item.text} className="draggable-item flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button onClick={() => moveUp(index)} className="w-10 h-10 rounded-lg bg-muted hover:bg-secondary hover:text-secondary-foreground transition-colors text-xl">⬆️</button>
              <button onClick={() => moveDown(index)} className="w-10 h-10 rounded-lg bg-muted hover:bg-secondary hover:text-secondary-foreground transition-colors text-xl">⬇️</button>
            </div>
          </div>
        ))}
      </div>
...
function Task2() {
  ...
  return (
    <div className="task-card">
      ...
      <div className="card-fun bg-muted/50 mb-6">
        <div className="space-y-3 text-lg">
          <div className="flex items-center gap-3 p-2 bg-background/50 rounded-lg">
            ...
            <img src={openFolderImg} alt="Файл мәзірі" className="w-8 h-8 rounded-lg" />
      ...
      <p className="font-bold mb-4 flex items-center gap-2">❓ Қандай қадам жетіспейді?</p>
        ...
        {[
          ...
          <button
            ...
            className={`w-full text-left p-4 rounded-xl border-2 transition-all flex items-center gap-4 ${
              selected === option.id ? 'border-secondary bg-secondary/10' : 'border-border hover:border-secondary/50'
            }`}
          >
